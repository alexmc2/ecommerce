...
export type AllSanitySchemaTypes = ReviewsCarousel | LottieAnimation | MenuGoogleSection | MenuSection | AllPosts | LocationMap | FormContactMap | FormContact | FormNewsletter | Faqs | LogoCloud1 | Cta1 | Timelines1 | TimelineRow | ImageGallery | Carousel2 | Carousel1 | ProductGrid | GridRow | GridPost | PricingCard | GridCard | SplitLocationMap | SplitContactForm | SplitInfo | SplitInfoList | SplitImage | SplitCard | SplitCardsList | SplitContent | SplitRow | RichTextBlock | SectionHeader | HeroFull | Hero2 | Hero1 | ProductVariant | SectionPadding | ButtonVariant | ColorVariant | Link | BlockContent | Product | Settings | Navigation | Testimonial | Faq | Category | Page | Collection | Post | Author | Code | SanityImagePaletteSwatch | SanityImagePalette | SanityImageDimensions | SanityImageHotspot | SanityImageCrop | SanityFileAsset | SanityImageAsset | SanityImageMetadata | Geopoint | Slug | SanityAssetSourceData;
...
export type PAGE_QUERYResult = {
  blocks: Array<{
    ...
    titleStyle: {
      fontFamily: "display" | "mono" | "sans" | "serif" | null;
      fontWeight: "bold" | "extrabold" | "light" | "medium" | "normal" | "semibold" | null;
      fontSize: "2xl" | "lg" | "md" | "sm" | "xl" | null;
    } | null;
    body: Array<{
      children?: Array<{
        marks?: Array<string>;
...
// Query: *[_type == "collection" && _id == $collectionId][0]{    products[]->{        _id,  title,  slug,  price,  compareAtPrice,  excerpt,  images[]{      ...,  asset->{    _id,    _createdAt,    url,    mimeType,    metadata {      lqip,      dimensions {        width,        height      }    }  }  }    }  }
