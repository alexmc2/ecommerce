...
import { Eye, Heart, MoreHorizontal, ShoppingCart } from '@/lib/icons';
...
export default function ProductCard({
  ...
  return (
    ...
    >
      <div className="relative flex min-h-[280px] w-full items-center justify-center overflow-hidden border-b border-border/60 bg-muted">
        <Link
          href={`/products/${slug}`}
        ...
        <div className="pointer-events-none absolute inset-x-4 bottom-4 z-20 flex items-center gap-2 rounded-md bg-background/95 p-2 opacity-0 translate-y-6 ring-1 ring-border/40 shadow-sm transition-all duration-200 ease-out group-hover:pointer-events-auto group-hover:translate-y-0 group-hover:opacity-100">
          {showQuickView && (
            <Button
              asChild
              variant="outline"
...
//       {/* IMAGE = the only “card”. Text sits on page background below. */}
//       <div
//         className={cn(
//           'relative w-full aspect-square overflow-hidden rounded-2xl border border-border/60 bg-muted shadow-sm',
...
//         {/* Overlay toolbar on hover/focus */}
...
//       {/* TEXT BELOW — sits on page background, not inside a card */}
