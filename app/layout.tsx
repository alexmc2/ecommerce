...
const defaultDescription =
  'A Next.js and Sanity.io starter for flexible content websites.';
const defaultLogoUrl = new URL('/demo-logo.svg', metadataBase).toString();

export const metadata: Metadata = {
  metadataBase,
  title: {
    template: '%s | Demo Template',
    default: 'Demo Template | Flexible Website Starter',
  },
  description: defaultDescription,
  openGraph: {
    title: 'Demo Template | Flexible Website Starter',
    description: defaultDescription,
    images: [
      {
